...
let _pathNormalize = path.normalize;
  ...
  if (options.username || options.password) {
    before.push(function (req, res) {
      ...
      if (credentials) {
        ...
        // type
        let usernameEqual = secureCompare(options.username.toString(), credentials.name);
        let passwordEqual = secureCompare(options.password.toString(), credentials.pass);
